...
print('Adding split data into ACMs\n')
train_acm.write((split.X_train, split.y_train))
test_acm.write((split.X_test , split.y_test))

#train and test run concurrently 
#Step 3 :Preprocess
print('Data are retrieved from the ACMs\n')
X_train, y_train = train_acm.read()
X_test,  y_test  = test_acm.read()
...
#add output into acms
print('loaders and dataset are added into the ACMs\n')
train_acm.write(batch_train.loader)
test_acm.write(batch_test.loader)
test_dataset_acm.write(batch_test.dataset)
...
#gets loaders from ACMs for train class
print('Retrieving loaders from ACMs\n')
train_loader = train_acm.read()
test_loader = test_acm.read()
...
#adds losses into ACMs
print('adding losses into ACMs\n')
losses = losses_acm.write((train.test_losses , train.train_losses))

print('retreiving dataset and losses from ACMs\n')
dataset = test_dataset_acm.read()
train , test = losses_acm.read()
